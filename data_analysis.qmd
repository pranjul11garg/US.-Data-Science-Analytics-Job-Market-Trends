...
```
<iframe src="figures/ploto_heatmap.html" width="100%" height="100%" frameborder="0"></iframe>
...
```
<iframe src="figures/plot1_jobtrends.html" width="100%" height="100%" frameborder="0"></iframe>
...
fig = px.bar(df_top_industries, 
             ...
             barmode='group')
```
<iframe src="figures/plot2industries.html" width="100%" height="100%" frameborder="0"></iframe>
