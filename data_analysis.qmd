...
```
<iframe src="figures/plot1_jobtrends.html" width="100%" height="700px" style="border:none;"></iframe>
...
fig = px.bar(df_top_industries, 
             ...
             barmode='group')
```
<iframe src="figures/plot2industries.html" width="100%" height="700px" style="border:none;"></iframe>
