...
# this lives in a code cell
IFrame(src="figures/edaplot1.html", width="100%", height=500)
```
...
from IPython.display import IFrame
IFrame(src="figures/edaplot2.html", width="100%", height=500)
```
...
from IPython.display import IFrame
IFrame(src="figures/edaplot3.html", width="50%", height=500)
```
...
from IPython.display import IFrame
IFrame(src="figures/edaplot4.html", width="100%", height=500)
```
...
from IPython.display import IFrame
IFrame(src="figures/edaplot5.html", width="100%", height=500)
```
